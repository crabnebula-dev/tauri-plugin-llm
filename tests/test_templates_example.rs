...
mod tests {
    ...
    use tauri_plugin_llm::TokenizerConfig;
    ...
    fn test_from_existing_files() {
        ...
        let tokenizer_config: TokenizerConfig =
            serde_json::from_reader(&chat_template_file_contents)
        ...
        let template =
            ChatTemplate::from_tokenizer_config_str(&tokenizer_config.chat_template.unwrap());
